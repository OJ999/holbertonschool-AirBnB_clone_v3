...
class TestDBStorageDocs(unittest.TestCase):
    ...
    def test_doc_file(self):
        ...
        actual = db_storage.__doc__ # type: ignore
...
class TestStateDBInstances(unittest.TestCase):
    ...
    def test_state_all(self):
        ...
        all_objs = storage.all() # type: ignore
        all_state_objs = storage.all('State') # type: ignore
    ...
    def test_state_delete(self):
        ...
        storage.delete(self.state) # type: ignore
        self.state = None
        storage.save() # type: ignore
        exist_in_all = False
        for k in storage.all().keys(): # type: ignore
            if state_id in k:
                exist_in_all = True
...
class TestUserDBInstances(unittest.TestCase):
    ...
    def test_user_all(self):
        """... checks if all() function returns newly created instance"""
        all_objs = storage.all() # type: ignore
        all_user_objs = storage.all('User') # type: ignore
    ...
    def test_user_delete(self):
        ...
        storage.delete(self.user) # type: ignore
        self.user = None
        storage.save() # type: ignore
        exist_in_all = False
        for k in storage.all().keys(): # type: ignore
...
class TestCityDBInstances(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.state.name = 'California'
        self.state.save()
        self.city = City() # type: ignore # type: ignore
    ...
    def test_city_all(self):
        """... checks if all() function returns newly created instance"""
        all_objs = storage.all() # type: ignore
        all_city_objs = storage.all('City') # type: ignore
...
class TestPlaceDBInstances(unittest.TestCase):
    ...
    def test_place_all(self):
        """... checks if all() function returns newly created instance"""
        all_objs = storage.all() # type: ignore
        all_place_objs = storage.all('Place') # type: ignore # type: ignore
...
class TestStorageGet(unittest.TestCase):
    ...
    def setUp(self):
        ...
        setup method
        """
        self.state = State(name="Florida") # type: ignore
        self.state.save()
    ...
    def test_get_method_obj(self):
        ...
        """
        result = storage.get(cls="State", id=self.state.id) # type: ignore

        self.assertIsInstance(result, State) # type: ignore
    ...
    def test_get_method_return(self):
        ...
        :return: True if pass, false if not pass
        """
        result = storage.get(cls="State", id=str(self.state.id)) # type: ignore
    ...
    def test_get_method_none(self):
        ...
        :return: True if pass, false if not pass
        """
        result = storage.get(cls="State", id="doesnotexist") # type: ignore # type: ignore
...
class TestStorageCount(unittest.TestCase):
    ...
    def setup(self):
        ...
        setup method
        """
        self.state1 = State(name="California") # type: ignore
        self.state1.save()
        self.state2 = State(name="Colorado") # type: ignore # type: ignore
        self.state2.save()
        self.state3 = State(name="Wyoming") # type: ignore
        self.state3.save()
        self.state4 = State(name="Virgina") # type: ignore
        self.state4.save()
        self.state5 = State(name="Oregon") # type: ignore
        self.state5.save()
        self.state6 = State(name="New_York") # type: ignore
        self.state6.save()
        self.state7 = State(name="Ohio") # type: ignore # type: ignore
        self.state7.save()
    ...
    def test_count_all(self):
        ...
        :return: True if pass, false if not pass
        """
        result = storage.count() # type: ignore

        self.assertEqual(len(storage.all()), result) # type: ignore
    ...
    def test_count_state(self):
        ...
        :return: True if pass, false if not pass
        """
        result = storage.count(cls="State") # type: ignore

        self.assertEqual(len(storage.all("State")), result) # type: ignore
    ...
    def test_count_city(self):
        ...
        :return: True if pass, false if not pass
        """
        result = storage.count(cls="City") # type: ignore

        self.assertEqual(int(0 if len(storage.all("City")) is None else # type: ignore
                             len(storage.all("City"))), result) # type: ignore
